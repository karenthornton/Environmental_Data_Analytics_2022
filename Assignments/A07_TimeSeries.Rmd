...
> Answer: Even with seasonality, the time series is still statistically significant (ozone increaseing over time). The p-value is 0.04965 which is less than 0.05, meaning the ozone has changed significantly since 2010.
...
> Answer: The p-value for the Mann-Kendall test (p-value = 0.04965) was a lot smaller (more statistically significant) than the Seasonal Mann-Kendall test (p-value = 0.00754). This shows that if you take the seasonality out of the equation the data is stil statistically significant. The ozone is still increasing with time. 
