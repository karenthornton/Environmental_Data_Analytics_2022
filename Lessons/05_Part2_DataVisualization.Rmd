...
mytheme <- theme_classic(base_size = 14) +
  #what does base_size mean?
  theme(axis.text = element_text(color = "black"), 
        legend.position = "top") #alternative: legend.position + legend.justification (right,left, center alignment)
...
NvsP2 <-
  ...
  labs(color ="depth", shape = "lake_name") + # change your legend labels here
...
#relative heights of the two different plots (1.25 and 1)
