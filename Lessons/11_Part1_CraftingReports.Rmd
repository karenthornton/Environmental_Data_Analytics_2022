...
```{r}
#I want this one to show up, but it doesn't 
...
```{r tables, echo=FALSE}
#I want the output to show up, but not the code (right now nothing is showing up)
...
#I want the final figures to show up, but not the code (right now nothing is showing up)
