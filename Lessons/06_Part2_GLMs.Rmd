...
#null hypothesis for anova is that the means are all the same so if p value is less than 0.05 then you reject the null meaning the means are not the same!
