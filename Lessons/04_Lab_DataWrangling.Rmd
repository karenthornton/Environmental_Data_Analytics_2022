...
#do for a range? because you can just write the first and last
...
NTL.phys.data.TuesLake1990to1999 <- NTL.phys.data %>%
...
NTL.phys.data.gathered <-
  pivot_longer(NTL.phys.data, irradianceWater:irradianceDesk, names_to = "irradiance", values_to = "radiation")
