...
#putting ht height and width on the top applies it to the whole chunk
# Scatterplot
...
print(Nutrientplot3)
#fill will color the box

# Dot plot
Nutrientplot4 <-
  ggplot(PeterPaul.chem.nutrients.gathered, aes(x = lakename, y = concentration)) +
  geom_dotplot(aes(color = nutrient, fill = nutrient), binaxis = "y", binwidth = 1, 
               stackdir = "center", position = "dodge", dotsize = 2) #binaxis y means stack it by the y-axis, dodge means no overlay of dots
print(Nutrientplot4)
...
#color inside th aes gives a legend for free
print(Nutrientplot7)
...
Nutrientplot6 <-
  ...
  geom_density_ridges(aes(fill = lakename), alpha = 0.5) # what does alpha mean?
print(Nutrientplot6)
