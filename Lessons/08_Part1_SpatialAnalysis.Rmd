...
#if you just downloaded it then it might not include the geometry
...
#Explore
class(GasPlants)
#sf object means you can do spatial analysis
names(GasPlants)
...
#has coordinates as x and y axis
...
#a point but doesn't know where it is
